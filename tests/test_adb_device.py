...
class TestAdbDevice(unittest.TestCase):
    ...
    def test_init_banner(self):
        ...
        device_with_banner2 = AdbDevice(
            transport=patchers.FakeTcpTransport("host", 5555), banner=bytearray("banner2", "utf-8")
        )
        self.assertEqual(device_with_banner2._banner, b"banner2")

        device_with_banner3 = AdbDevice(transport=patchers.FakeTcpTransport("host", 5555), banner="banner3")
    ...
    def test_shell_local_id_wraparound(self):
        ...
        # Provide the `bulk_read` return values
        self.transport.bulk_read_data = join_messages(
            AdbMessage(command=constants.OKAY, arg0=1, arg1=2**32 - 1, data=b"\x00"),
    ...
    def test_shell_multibytes_sequence_exceeds_max(self):
        ...
        self.transport.bulk_read_data = join_messages(
            AdbMessage(command=constants.OKAY, arg0=1, arg1=1, data=b"\x00"),
            AdbMessage(
                command=constants.WRTE, arg0=1, arg1=1, data=b"0" * (constants.MAX_ADB_DATA - 1) + b"\xe3\x81\x82"
            ),
            AdbMessage(command=constants.CLSE, arg0=1, arg1=1, data=b""),
        )

        self.assertEqual("0" * (constants.MAX_ADB_DATA - 1) + "\u3042", self.device.shell("TEST"))
    ...
    def test_shell_with_multibytes_sequence_over_two_messages(self):
        ...
        self.assertEqual("\u3042", self.device.shell("TEST"))
    ...
    def test_shell_multiple_clse(self):
        ...
        self.transport.bulk_read_data = b"".join(
            [
    ...
    def test_shell_error_unknown_command(self):
        ...
        # Provide the `bulk_read` return values
        self.transport.bulk_read_data = join_messages(
            AdbMessageForTesting(command=constants.FAIL, arg0=1, arg1=1, data=b"")
        )
    ...
    def test_exec_out(self):
        ...
        self.transport.bulk_read_data = b"".join(
            [
                b"OKAY\x14\x00\x00\x00\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xb0\xb4\xbe\xa6",
    ...
    def test_list(self):
        ...
        self.transport.bulk_read_data = join_messages(
            ...
            AdbMessage(
                command=constants.WRTE,
                arg0=1,
                arg1=1,
                data=join_messages(
                    FileSyncListMessage(constants.DENT, 1, 2, 3, data=b"file1"),
        ...
        expected_bulk_write = join_messages(
            AdbMessage(command=constants.OPEN, arg0=1, arg1=0, data=b"sync:\x00"),
            AdbMessage(
                command=constants.WRTE,
                arg0=1,
                arg1=1,
                data=join_messages(FileSyncMessage(command=constants.LIST, data=b"/dir")),
            ),
            AdbMessage(command=constants.OKAY, arg0=1, arg1=1),
            AdbMessage(command=constants.CLSE, arg0=1, arg1=1, data=b""),
        )
    ...
    def test_push_fail(self):
        ...
        self.transport.bulk_read_data = join_messages(
            ...
            AdbMessage(command=constants.OKAY, arg0=1, arg1=1, data=b""),
            AdbMessage(
                command=constants.WRTE, arg0=1, arg1=1, data=join_messages(FileSyncMessage(constants.FAIL, data=b""))
            ),
        )

        with self.assertRaises(exceptions.PushFailedError), patch(
            "adb_shell.adb_device.open", patchers.mock_open(read_data=filedata)
        ):
    ...
    def test_push_file_mtime0(self):
        ...
        self.transport.bulk_read_data = join_messages(
            ...
            AdbMessage(command=constants.OKAY, arg0=1, arg1=1, data=b""),
            AdbMessage(
                command=constants.WRTE, arg0=1, arg1=1, data=join_messages(FileSyncMessage(constants.OKAY, data=b""))
            ),
            AdbMessage(command=constants.CLSE, arg0=1, arg1=1, data=b""),
        )
        ...
        with patch("adb_shell.adb_device.open", patchers.mock_open(read_data=filedata)), patch(
            "time.time", return_value=mtime
        ):
            self.device.push("TEST_FILE", "/data", mtime=mtime)
            self.assertEqual(expected_bulk_write, self.transport.bulk_write_data)
    ...
    def test_push_big_file(self):
        ...
        expected_bulk_write = join_messages(
            ...
            AdbMessage(
                ...
                arg0=1,
                arg1=1,
                data=join_messages(FileSyncMessage(command=constants.DATA, data=filedata[mcs1:mcs2])),
            ),
            AdbMessage(
                command=constants.WRTE,
                arg0=1,
    ...
    def test_push_dir(self):
        ...
        with patch("adb_shell.adb_device.open", patchers.mock_open(read_data=filedata)), patch(
            "os.path.isdir", lambda x: x == "TEST_DIR/"
        ), patch("os.listdir", return_value=["TEST_FILE1", "TEST_FILE2"]):
    ...
    def test_pull_file(self):
        ...
        self.transport.bulk_read_data = join_messages(
            ...
            AdbMessage(
                ...
                arg1=1,
                data=join_messages(
                    FileSyncMessage(command=constants.DATA, data=filedata), FileSyncMessage(command=constants.DONE)
                ),
            ),
            AdbMessage(command=constants.CLSE, arg0=1, arg1=1, data=b""),
        )
        ...
        expected_bulk_write = join_messages(
            ...
            AdbMessage(
                ...
                arg0=1,
                arg1=1,
                data=join_messages(FileSyncMessage(command=constants.RECV, data=b"/data")),
            ),
            AdbMessage(command=constants.OKAY, arg0=1, arg1=1),
            AdbMessage(command=constants.CLSE, arg0=1, arg1=1, data=b""),
        )
    ...
    def test_pull_non_existant_path(self):
        ...
        expected_bulk_write = join_messages(
            ...
            AdbMessage(
                ...
                arg0=1,
                arg1=1,
                data=join_messages(FileSyncMessage(command=constants.RECV, data=b"/does/not/exist")),
            ),
            AdbMessage(command=constants.OKAY, arg0=1, arg1=1),
            AdbMessage(command=constants.OKAY, arg0=1, arg1=1),
            AdbMessage(command=constants.CLSE, arg0=1, arg1=1, data=b""),
    ...
    def test_pull_non_existant_path_2(self):
        ...
        self.transport.bulk_read_data = join_messages(
            ...
            AdbMessage(command=constants.OKAY, arg0=1, arg1=1, data=b""),
            AdbMessage(
                command=constants.WRTE, arg0=1, arg1=1, data=b"FAIL&\x00\x00\x00open failed: No such file or directory"
            ),
            AdbMessage(command=constants.CLSE, arg0=1, arg1=1, data=b""),
        )
    ...
    def test_stat(self):
        ...
        self.transport.bulk_read_data = join_messages(
            ...
            AdbMessage(
                ...
                arg1=1,
                data=join_messages(
                    FileSyncStatMessage(constants.STAT, 1, 2, 3), FileSyncStatMessage(constants.DONE, 0, 0, 0)
                ),
            ),
            AdbMessage(command=constants.CLSE, arg0=1, arg1=1, data=b""),
        )
        ...
        expected_bulk_write = join_messages(
            ...
            AdbMessage(
                ...
                arg0=1,
                arg1=1,
                data=join_messages(FileSyncMessage(command=constants.STAT, data=b"/data")),
            ),
            AdbMessage(command=constants.OKAY, arg0=1, arg1=1, data=b""),
            AdbMessage(command=constants.CLSE, arg0=1, arg1=1, data=b""),
        )
    ...
    def test_stat_issue155(self):
        ...
        mtime = 1230735600
        self.assertEqual(
            FileSyncStatMessage(constants.STAT, mode, size, mtime).pack(),
            b"STAT\xedA\x00\x00\x00\x10\x00\x00\xf0\x88[I",
        )
    ...
    def test_filesync_read_adb_command_failure_exceptions(self):
        ...
        self.transport.bulk_read_data = join_messages(
            ...
            AdbMessage(
                ...
                arg1=1,
                data=join_messages(
                    FileSyncStatMessage(constants.FAIL, 1, 2, 3), FileSyncStatMessage(constants.DONE, 0, 0, 0)
                ),
            ),
        )
    ...
    def test_filesync_read_invalid_response_error(self):
        ...
        self.transport.bulk_read_data = join_messages(
            ...
            AdbMessage(
                ...
                arg1=1,
                data=join_messages(
                    FileSyncStatMessage(constants.DENT, 1, 2, 3), FileSyncStatMessage(constants.DONE, 0, 0, 0)
                ),
            ),
        )
